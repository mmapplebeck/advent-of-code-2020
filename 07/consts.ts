export const PATTERN = new RegExp("^(\\d )*(.+) bag.*$");
export const NO_OTHER = "no other";
export const SHINY_GOLD = "shiny gold";

export const INPUT = `dim red bags contain 2 bright gold bags, 5 striped fuchsia bags.
